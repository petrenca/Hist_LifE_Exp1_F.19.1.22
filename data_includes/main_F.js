...
// sequence
// test run:
//PennController.Sequence("post_task_intro", "post_task_prac", "post_task_start", "post_task", "final");
...
PennController("demographics",
               ...
               newText("information", "<p>Before continuing the experiment, please read our"
                       +" <a href='https://amor.cms.hu-berlin.de/~petrenca/Hist_LE/EN_info_sheet_ONLINE_Exp1.pdf' target='_blank' >Participant's Information Sheet</a> and"
                       +" <a href='https://amor.cms.hu-berlin.de/~petrenca/Hist_LE/EN_consentAgreement_ONLINE_Exp1.pdf' target='_blank'>Consent Form</a>.<p>")    
               .settings.css("font-size", "20px")
               ,
...
PennController( "instructions1",
                ...
                .settings.add(70,320, getText("example1"))
                .print()  
                ,
                newKey("ex1"," ")
                .wait()
                ...
                .settings.add(70,320, getText("example2"))
                ,
                newKey("ex2"," ")
                .wait()
                ,
                ...
                .settings.add(70,320, getText("example3"))
                .print()  
                ,                
                newKey("ex3"," ")
                .wait()
                ...
                .settings.add(70,320, getText("example4"))
                ,
                newKey("ex4"," ")
                .wait()
                ,
...
PennController.Template( PennController.GetTable( "Crit_Stimuli_HistLifetime.csv")
                         ...
                         variable => ["critical_yes",
                                      ...
                                      .disable()
                                      ,
                                      getVar("sentence_rating") // this will create a new variable "sentence_rating"
                                      .global().set(0)
                                      .set(getKey("sentence_rating") )
...
PennController( "post_task_intro",
                ...
                newText("comp1_2", "You will be presented with some prompts to which you respond using the <b>F</b> and <b>J</b> keys:"
                        + " <p>(1) You will see a <b> name</b> from the experiment. Press F or J to indicate if you're familiar with the person."
    ...
    .log( "notice", "post_task_intro")   
    .log( "about", "post_task_intro")         
    .log( "easyhard", "post_task_intro")       
    .log( "strategy", "post_task_intro")    
...
PennController. Template( PennController.GetTable( "Crit_Stimuli_HistLifetime.csv")// change this line for the appropriate experimental list
                          ...
                          variable => ["post_task_prac",
                                       ...
                                       .log("match", variable.match)
                                       .log( "condition" , variable.condition)
                                       .log("sentence_rating", "post_task_prac")
                                       ...
                                       .log( "notice", "post_task_prac") 
                                       .log( "about", "post_task_prac")      
                                       .log( "easyhard", "post_task_prac")    
                                       .log( "strategy", "post_task_prac")
...
PennController( "post_task_start",
    ...
    .log( "notice", "post_task_intro2") 
    .log( "about", "post_task_intro2")     
    .log( "easyhard", "post_task_intro2")   
    .log( "strategy", "post_task_intro2")
